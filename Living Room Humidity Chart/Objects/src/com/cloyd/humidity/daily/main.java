...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 //BA.debugLineNum = 598;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
 //BA.debugLineNum = 599;BA.debugLine="Awake.ReleaseKeepAlive";
_awake.ReleaseKeepAlive();
 //BA.debugLineNum = 600;BA.debugLine="If UserClosed Then";
if (_userclosed) { 
 //BA.debugLineNum = 601;BA.debugLine="lc1.RemoveView";
mostCurrent._lc1.RemoveView();
 };
...
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 593;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 594;BA.debugLine="Awake.KeepAlive(True)";
_awake.KeepAlive(processBA,anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 595;BA.debugLine="Activity_WindowFocusChanged(True)";
_activity_windowfocuschanged(anywheresoftware.b4a.keywords.Common.True);
...
_minvalue = (float) (0);
_maxvalue = (float) (0);
 //BA.debugLineNum = 538;BA.debugLine="If tempRightNow <= tempList.Get(0) Then";
if ((double)(Double.parseDouble(mostCurrent._temprightnow))<=(double)(BA.ObjectToNumber(_templist.Get((int) (0))))) { 
 //BA.debugLineNum = 539;BA.debugLine="If tempMinRange <= tempRightNow Then";
if (_tempminrange<=(double)(Double.parseDouble(mostCurrent._temprightnow))) { 
 //BA.debugLineNum = 540;BA.debugLine="minValue = tempMinRange-1.5";
_minvalue = (float) (_tempminrange-1.5);
 }else {
 //BA.debugLineNum = 542;BA.debugLine="minValue = tempRightNow-1.5";
_minvalue = (float) ((double)(Double.parseDouble(mostCurrent._temprightnow))-1.5);
 };
 }else {
 //BA.debugLineNum = 545;BA.debugLine="If tempMinRange > 0 And tempMinRange <= tempList";
if (_tempminrange>0 && _tempminrange<=(double)(BA.ObjectToNumber(_templist.Get((int) (0))))) { 
 //BA.debugLineNum = 546;BA.debugLine="minValue = tempMinRange-1.5";
_minvalue = (float) (_tempminrange-1.5);
 }else {
 //BA.debugLineNum = 548;BA.debugLine="minValue = tempList.Get(0)-1.5";
_minvalue = (float) ((double)(BA.ObjectToNumber(_templist.Get((int) (0))))-1.5);
 };
 };
 //BA.debugLineNum = 552;BA.debugLine="If tempList.Get(tempList.Size-1) >= 88.88 Then";
if ((double)(BA.ObjectToNumber(_templist.Get((int) (_templist.getSize()-1))))>=88.88) { 
 //BA.debugLineNum = 553;BA.debugLine="If tempRightNow >= (tempList.Get(tempList.Size-2";
if ((double)(Double.parseDouble(mostCurrent._temprightnow))>=(double)(BA.ObjectToNumber((_templist.Get((int) (_templist.getSize()-2)))))) { 
 //BA.debugLineNum = 554;BA.debugLine="If tempMaxRange >= tempRightNow Then";
if (_tempmaxrange>=(double)(Double.parseDouble(mostCurrent._temprightnow))) { 
 //BA.debugLineNum = 555;BA.debugLine="maxValue =  tempMaxRange+1.5";
_maxvalue = (float) (_tempmaxrange+1.5);
 }else {
 //BA.debugLineNum = 557;BA.debugLine="maxValue = tempRightNow+1.5";
_maxvalue = (float) ((double)(Double.parseDouble(mostCurrent._temprightnow))+1.5);
 };
 }else {
 //BA.debugLineNum = 560;BA.debugLine="If tempMaxRange >= (tempList.Get(tempList.Size-";
if (_tempmaxrange>=(double)(BA.ObjectToNumber((_templist.Get((int) (_templist.getSize()-2)))))) { 
 //BA.debugLineNum = 561;BA.debugLine="maxValue =  tempMaxRange+1.5";
_maxvalue = (float) (_tempmaxrange+1.5);
 }else {
 //BA.debugLineNum = 563;BA.debugLine="maxValue = (tempList.Get(tempList.Size-2))+1.5";
_maxvalue = (float) ((double)(BA.ObjectToNumber((_templist.Get((int) (_templist.getSize()-2)))))+1.5);
 };
 };
 }else {
 //BA.debugLineNum = 567;BA.debugLine="If tempRightNow >= (tempList.Get(tempList.Size-1";
if ((double)(Double.parseDouble(mostCurrent._temprightnow))>=(double)(BA.ObjectToNumber((_templist.Get((int) (_templist.getSize()-1)))))) { 
 //BA.debugLineNum = 568;BA.debugLine="If tempMaxRange >= tempRightNow Then";
if (_tempmaxrange>=(double)(Double.parseDouble(mostCurrent._temprightnow))) { 
 //BA.debugLineNum = 569;BA.debugLine="maxValue =  tempMaxRange+1.5";
_maxvalue = (float) (_tempmaxrange+1.5);
 }else {
 //BA.debugLineNum = 571;BA.debugLine="maxValue = tempRightNow+1.5";
_maxvalue = (float) ((double)(Double.parseDouble(mostCurrent._temprightnow))+1.5);
 };
 }else {
 //BA.debugLineNum = 574;BA.debugLine="If tempMaxRange >= (tempList.Get(tempList.Size-";
if (_tempmaxrange>=(double)(BA.ObjectToNumber((_templist.Get((int) (_templist.getSize()-1)))))) { 
 //BA.debugLineNum = 575;BA.debugLine="maxValue =  tempMaxRange+1.5";
_maxvalue = (float) (_tempmaxrange+1.5);
 }else {
 //BA.debugLineNum = 577;BA.debugLine="maxValue = (tempList.Get(tempList.Size-1))+1.5";
_maxvalue = (float) ((double)(BA.ObjectToNumber((_templist.Get((int) (_templist.getSize()-1)))))+1.5);
 };
 };
 };
 //BA.debugLineNum = 582;BA.debugLine="If (maxValue-1.5) >= tempMaxRange Then";
if ((_maxvalue-1.5)>=_tempmaxrange) { 
 //BA.debugLineNum = 583;BA.debugLine="tempMaxRange = maxValue-1.5";
_tempmaxrange = (float) (_maxvalue-1.5);
 };
 //BA.debugLineNum = 586;BA.debugLine="tempMinRange = minValue+1.5";
_tempminrange = (float) (_minvalue+1.5);
 //BA.debugLineNum = 589;BA.debugLine="lc1.YaxisRange(minValue, maxValue)";
...
String[] _a = null;
String _timestamp = "";
 //BA.debugLineNum = 605;BA.debugLine="Sub ReadTextReader(fileDay As String)";
 //BA.debugLineNum = 606;BA.debugLine="Try";
try { //BA.debugLineNum = 607;BA.debugLine="Dim TextReader1 As TextReader";
_textreader1 = new anywheresoftware.b4a.objects.streams.File.TextReaderWrapper();
 //BA.debugLineNum = 608;BA.debugLine="Dim Now As Long";
_now = 0L;
 //BA.debugLineNum = 609;BA.debugLine="Dim Month As Int";
_month = 0;
 //BA.debugLineNum = 610;BA.debugLine="Dim Day As Int";
_day = 0;
 //BA.debugLineNum = 611;BA.debugLine="Dim Year As Int";
_year = 0;
 //BA.debugLineNum = 612;BA.debugLine="Dim FileName As String";
_filename = "";
 //BA.debugLineNum = 614;BA.debugLine="am12 = zeroRange";
mostCurrent._am12 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 615;BA.debugLine="am1 = zeroRange";
mostCurrent._am1 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 616;BA.debugLine="am2 = zeroRange";
mostCurrent._am2 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 617;BA.debugLine="am3 = zeroRange";
mostCurrent._am3 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 618;BA.debugLine="am4 = zeroRange";
mostCurrent._am4 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 619;BA.debugLine="am5 = zeroRange";
mostCurrent._am5 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 620;BA.debugLine="am6 = zeroRange";
mostCurrent._am6 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 621;BA.debugLine="am7 = zeroRange";
mostCurrent._am7 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 622;BA.debugLine="am8 = zeroRange";
mostCurrent._am8 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 623;BA.debugLine="am9 = zeroRange";
mostCurrent._am9 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 624;BA.debugLine="am10 = zeroRange";
mostCurrent._am10 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 625;BA.debugLine="am11 = zeroRange";
mostCurrent._am11 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 626;BA.debugLine="pm12 = zeroRange";
mostCurrent._pm12 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 627;BA.debugLine="pm1 = zeroRange";
mostCurrent._pm1 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 628;BA.debugLine="pm2 = zeroRange";
mostCurrent._pm2 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 629;BA.debugLine="pm3 = zeroRange";
mostCurrent._pm3 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 630;BA.debugLine="pm4 = zeroRange";
mostCurrent._pm4 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 631;BA.debugLine="pm5 = zeroRange";
mostCurrent._pm5 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 632;BA.debugLine="pm6 = zeroRange";
mostCurrent._pm6 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 633;BA.debugLine="pm7 = zeroRange";
mostCurrent._pm7 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 634;BA.debugLine="pm8 = zeroRange";
mostCurrent._pm8 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 635;BA.debugLine="pm9 = zeroRange";
mostCurrent._pm9 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 636;BA.debugLine="pm10 = zeroRange";
mostCurrent._pm10 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 637;BA.debugLine="pm11 = zeroRange";
mostCurrent._pm11 = BA.NumberToString(_zerorange);
 //BA.debugLineNum = 639;BA.debugLine="Now = DateTime.Now";
_now = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 640;BA.debugLine="Month = DateTime.GetMonth(Now)";
_month = anywheresoftware.b4a.keywords.Common.DateTime.GetMonth(_now);
 //BA.debugLineNum = 641;BA.debugLine="Day = DateTime.GetDayOfMonth (Now)";
_day = anywheresoftware.b4a.keywords.Common.DateTime.GetDayOfMonth(_now);
 //BA.debugLineNum = 642;BA.debugLine="Year = DateTime.GetYear(Now)";
_year = anywheresoftware.b4a.keywords.Common.DateTime.GetYear(_now);
 //BA.debugLineNum = 644;BA.debugLine="If fileDay = \"Today\" Then";
if ((_fileday).equals("Today")) { 
 //BA.debugLineNum = 645;BA.debugLine="FileName = \"LivingRoomTempHumid_\" & Year & \"-\"";
_filename = "LivingRoomTempHumid_"+BA.NumberToString(_year)+"-"+anywheresoftware.b4a.keywords.Common.NumberFormat(_month,(int) (2),(int) (0))+"-"+anywheresoftware.b4a.keywords.Common.NumberFormat(_day,(int) (2),(int) (0))+".log";
 ...
 //BA.debugLineNum = 647;BA.debugLine="Now = DateTime.add(DateTime.Now, 0, 0, -1)";
_now = anywheresoftware.b4a.keywords.Common.DateTime.Add(anywheresoftware.b4a.keywords.Common.DateTime.getNow(),(int) (0),(int) (0),(int) (-1));
 //BA.debugLineNum = 648;BA.debugLine="Month = DateTime.GetMonth(Now)";
_month = anywheresoftware.b4a.keywords.Common.DateTime.GetMonth(_now);
 //BA.debugLineNum = 649;BA.debugLine="Day = DateTime.GetDayOfMonth (Now)";
_day = anywheresoftware.b4a.keywords.Common.DateTime.GetDayOfMonth(_now);
 //BA.debugLineNum = 650;BA.debugLine="Year = DateTime.GetYear(Now)";
_year = anywheresoftware.b4a.keywords.Common.DateTime.GetYear(_now);
 //BA.debugLineNum = 651;BA.debugLine="FileName = \"LivingRoomTempHumid_\" & Year & \"-\"";
_filename = "LivingRoomTempHumid_"+BA.NumberToString(_year)+"-"+anywheresoftware.b4a.keywords.Common.NumberFormat(_month,(int) (2),(int) (0))+"-"+anywheresoftware.b4a.keywords.Common.NumberFormat(_day,(int) (2),(int) (0))+".log";
 };
 //BA.debugLineNum = 654;BA.debugLine="TextReader1.Initialize(File.OpenInput(File.DirRo";
_textreader1.Initialize((java.io.InputStream)(anywheresoftware.b4a.keywords.Common.File.OpenInput(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),_filename).getObject()));
 //BA.debugLineNum = 655;BA.debugLine="Dim line As String";
_line = "";
 //BA.debugLineNum = 656;BA.debugLine="line = TextReader1.ReadLine";
_line = _textreader1.ReadLine();
 //BA.debugLineNum = 657;BA.debugLine="Do While line <> Null";
while (_line!= null) {
 //BA.debugLineNum = 659;BA.debugLine="line = TextReader1.ReadLine";
_line = _textreader1.ReadLine();
 //BA.debugLineNum = 660;BA.debugLine="If line = Null Then";
if (_line== null) { 
 //BA.debugLineNum = 661;BA.debugLine="Exit";
if (true) break;
 };
 //BA.debugLineNum = 663;BA.debugLine="Dim a() As String = Regex.Split(\"\\|\",line)";
_a = anywheresoftware.b4a.keywords.Common.Regex.Split("\\|",_line);
 //BA.debugLineNum = 664;BA.debugLine="If a.Length = 9 Then";
if (_a.length==9) { 
 //BA.debugLineNum = 665;BA.debugLine="Dim timeStamp As String";
_timestamp = "";
