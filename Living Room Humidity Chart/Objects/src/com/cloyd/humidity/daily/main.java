package com.cloyd.humidity.daily;
...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.cloyd.humidity.daily", "com.cloyd.humidity.daily.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.cloyd.humidity.daily", "com.cloyd.humidity.daily.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.cloyd.humidity.daily.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.cloyd.humidity.daily.starter _starter = null;
...
mostCurrent._lc1.setGraphTitleBold(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 82;BA.debugLine="lc1.GraphTitle = \" HUMIDITY DAILY v1.0  \"";
mostCurrent._lc1.setGraphTitle(" HUMIDITY DAILY v1.0  ");
...
mostCurrent._lc1.setYaxisLabelAndTitleDistance((float) (60.0));
 //BA.debugLineNum = 116;BA.debugLine="lc1.YaxisTitle = \"Humidity (%)\"";
...
public ResumableSub_Activity_WindowFocusChanged(com.cloyd.humidity.daily.main parent,boolean _hasfocus) {
this.parent = parent;
this._hasfocus = _hasfocus;
}
com.cloyd.humidity.daily.main parent;
boolean _hasfocus;
anywheresoftware.b4j.object.JavaObject _jo = null;
...
if ((_fileday).equals("Today")) { 
 //BA.debugLineNum = 714;BA.debugLine="tempRightNow = a(2)";
