...
anywheresoftware.b4a.keywords.Common.LogImpl("7131337",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
...
_timestamp = _a[(int) (0)].substring((int) (0),(int) (5));
 //BA.debugLineNum = 471;BA.debugLine="If IsNumber(a(2)) = False Then Continue";
...
if ((_fileday).equals("Today")) { 
 //BA.debugLineNum = 524;BA.debugLine="tempRightNow = a(2)";
