package com.cloyd.humidity.hourly;
...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.cloyd.humidity.hourly", "com.cloyd.humidity.hourly.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.cloyd.humidity.hourly", "com.cloyd.humidity.hourly.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.cloyd.humidity.hourly.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.cloyd.humidity.hourly.starter _starter = null;
...
mostCurrent._lc1.setGraphTitleBold(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 82;BA.debugLine="lc1.GraphTitle = \"HUMIDITY HOURLY v1.0\"";
mostCurrent._lc1.setGraphTitle("HUMIDITY HOURLY v1.0");
...
if ((_fileday).equals("Today")) { 
 //BA.debugLineNum = 519;BA.debugLine="tempRightNow = a(2)";
