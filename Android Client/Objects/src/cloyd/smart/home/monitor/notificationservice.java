...
anywheresoftware.b4a.keywords.Common.LogImpl("67798806",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("67536664","From Service: Loading unwatched videos took: "+BA.NumberToString((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_n))+"ms",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("67536680",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("67274565",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("67340064",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("67667740","RequestAuthToken error: "+_joblogin._errormessage /*String*/ ,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("67667746","RequestAuthToken LastException: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("67602195","RESTDownload LastException: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("67602197","URL: "+_url,0);
 //BA.debugLineNum = 216;BA.debugLine="Log(\"Response: \" & response)";
anywheresoftware.b4a.keywords.Common.LogImpl("67602198","Response: "+parent._response,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("67471109",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
