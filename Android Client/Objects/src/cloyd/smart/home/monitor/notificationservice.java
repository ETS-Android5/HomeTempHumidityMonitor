...
anywheresoftware.b4a.keywords.Common.LogImpl("38978454",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("38716312","From Service: Loading unwatched videos took: "+BA.NumberToString((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_n))+"ms",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("38716328",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("38454213",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("38519712",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("38847388","RequestAuthToken error: "+_joblogin._errormessage /*String*/ ,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("38847394","RequestAuthToken LastException: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("38781843","RESTDownload LastException: "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("38781845","URL: "+_url,0);
 //BA.debugLineNum = 216;BA.debugLine="Log(\"Response: \" & response)";
anywheresoftware.b4a.keywords.Common.LogImpl("38781846","Response: "+parent._response,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("38650757",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
