...
anywheresoftware.b4a.keywords.Common.LogImpl("77536664","From Service: Loading unwatched videos took: "+BA.NumberToString((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_n))+"ms",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("77536680",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 if (true) break;
if (true) break;
