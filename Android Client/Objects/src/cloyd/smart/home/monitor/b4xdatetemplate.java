...
public ResumableSub_Show(cloyd.smart.home.monitor.b4xdatetemplate parent,cloyd.smart.home.monitor.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
cloyd.smart.home.monitor.b4xdatetemplate parent;
...
parent._cvsdays.DrawText(ba,_d.substring((int) (0),(int) (2)),(float) ((_i-parent._firstday+0.5)*parent._boxw),(float) (parent.__c.DipToCurrent((int) (20))),_daysfont,parent._daysinweekcolor,BA.getEnumFromString(android.graphics.Paint.Align.class,"CENTER"));
 if (true) break;
if (true) break;
