...
__c.LogImpl("923789592","Multiline not supported with password mode.",0);
 };
...
public ResumableSub_SwitchFromPasswordToRegular(cloyd.smart.home.monitor.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
this._toregular = _toregular;
}
cloyd.smart.home.monitor.b4xfloattextfield parent;
boolean _toregular;
String _text = "";
int _textcolor = 0;
