...
anywheresoftware.b4a.keywords.Common.LogImpl("511796487",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 //BA.debugLineNum = 29;BA.debugLine="Log(\"Switching to File.DirInternal\")";
anywheresoftware.b4a.keywords.Common.LogImpl("511796488","Switching to File.DirInternal",0);
