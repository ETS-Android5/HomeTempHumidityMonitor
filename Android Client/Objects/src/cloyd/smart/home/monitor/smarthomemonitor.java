...
anywheresoftware.b4a.keywords.Common.LogImpl("77798810","Error in Sub LogEvent: "+anywheresoftware.b4a.keywords.Common.LastException(processBA).getMessage(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("77536649",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("77602179",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("77602189",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("77667716",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
...
_status = anywheresoftware.b4a.keywords.Common.BytesToString(_payload,(int) (0),_payload.length,"UTF8");
 //BA.debugLineNum = 106;BA.debugLine="If DateTime.GetSecond(DateTime.Now) Mod 5 = 0 T";
if (anywheresoftware.b4a.keywords.Common.DateTime.GetSecond(anywheresoftware.b4a.keywords.Common.DateTime.getNow())%5==0) { 
...
{
final int step135 = 1;
final int limit135 = (int) (_flist.getSize()-1);
_i = (int) (0) ;
...
_n.Cancel((int) (732));
			...
			processBA.setLastException(e347); //BA.debugLineNum = 486;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("77733635",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
