...
anywheresoftware.b4a.keywords.Common.LogImpl("49699348","Error loading state.",0);
 //BA.debugLineNum = 230;BA.debugLine="Log(LastException.Message)";
anywheresoftware.b4a.keywords.Common.LogImpl("49699349",anywheresoftware.b4a.keywords.Common.LastException(_ba).getMessage(),0);
