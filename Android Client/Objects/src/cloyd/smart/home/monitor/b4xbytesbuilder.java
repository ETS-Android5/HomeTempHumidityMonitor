...
public cloyd.smart.home.monitor.b4xbytesbuilder  _append2(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
...
if (_index>_mlength) { 
__c.LogImpl("916384002","Index too large",0);};
...
if (_index>_mlength) { 
__c.LogImpl("916449538","Index too large",0);};
