...
__c.LogImpl("012779531",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("012517430",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("012845069",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
