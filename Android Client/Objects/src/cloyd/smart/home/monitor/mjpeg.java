...
__c.LogImpl("114549003",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("114286902",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("114614541",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
