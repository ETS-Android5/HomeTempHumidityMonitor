...
__c.LogImpl("712779531",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("712517430",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("712845069",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
