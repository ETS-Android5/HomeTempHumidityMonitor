...
__c.LogImpl("614090251",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("613828150",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("614155789",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
