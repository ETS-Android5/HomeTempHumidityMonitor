...
__c.LogImpl("214614539",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("214352438",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("214680077",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
