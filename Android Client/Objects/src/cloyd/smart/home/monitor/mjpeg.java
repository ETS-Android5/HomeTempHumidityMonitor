...
__c.LogImpl("113959179",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("113697078",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("114024717",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("113500425",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
