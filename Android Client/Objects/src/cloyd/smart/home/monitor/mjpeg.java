...
__c.LogImpl("210944523",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("210682422",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("211010061",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
