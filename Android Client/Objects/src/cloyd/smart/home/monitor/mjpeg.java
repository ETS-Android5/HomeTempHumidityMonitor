...
__c.LogImpl("512779531",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("512517430",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("512845069",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
