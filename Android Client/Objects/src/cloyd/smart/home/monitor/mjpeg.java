...
__c.LogImpl("839976971",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("839714870",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("840042509",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("839518217",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
