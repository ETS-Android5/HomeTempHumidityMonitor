...
__c.LogImpl("412779531",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("412517430",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
...
__c.LogImpl("412845069",BA.ObjectToString(__c.LastException(getActivityBA())),0);
 };
