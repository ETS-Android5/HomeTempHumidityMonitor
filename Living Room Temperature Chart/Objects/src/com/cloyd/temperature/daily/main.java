...
_timestamp = _a[(int) (0)].substring((int) (0),(int) (2));
 //BA.debugLineNum = 668;BA.debugLine="If IsNumber(a(1)) = False Then Continue";
...
if ((_fileday).equals("Today")) { 
 //BA.debugLineNum = 721;BA.debugLine="tempRightNow = a(1)";
...
anywheresoftware.b4a.keywords.Common.LogImpl("3393339",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
