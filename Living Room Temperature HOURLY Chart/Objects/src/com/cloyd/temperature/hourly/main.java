...
public static String  _activity_click() throws Exception{
 //BA.debugLineNum = 577;BA.debugLine="Sub Activity_Click";
 //BA.debugLineNum = 578;BA.debugLine="Activity_WindowFocusChanged(True)";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 581;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 582;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 583;BA.debugLine="Timer1.Enabled = False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 584;BA.debugLine="lc1.RemoveView";
mostCurrent._lc1.RemoveView();
 //BA.debugLineNum = 585;BA.debugLine="ExitApplication";
anywheresoftware.b4a.keywords.Common.ExitApplication();
 //BA.debugLineNum = 586;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 }else {
 //BA.debugLineNum = 588;BA.debugLine="Return True";
...
_awake.ReleaseKeepAlive();
 //BA.debugLineNum = 398;BA.debugLine="If UserClosed Then";
if (_userclosed) { 
 //BA.debugLineNum = 399;BA.debugLine="lc1.RemoveView";
mostCurrent._lc1.RemoveView();
 };
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 558;BA.debugLine="Sub Activity_WindowFocusChanged(HasFocus As Boolea";
 //BA.debugLineNum = 559;BA.debugLine="If HasFocus Then";
if (_hasfocus) { 
 //BA.debugLineNum = 560;BA.debugLine="Try";
try { //BA.debugLineNum = 561;BA.debugLine="Dim jo As JavaObject = Activity";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(mostCurrent._activity.getObject()));
 //BA.debugLineNum = 563;BA.debugLine="jo.RunMethod(\"setSystemUiVisibility\", Array As";
...
anywheresoftware.b4j.object.JavaObject _point = null;
 //BA.debugLineNum = 538;BA.debugLine="Sub GetRealSize As LayoutValues";
 //BA.debugLineNum = 539;BA.debugLine="Dim lv As LayoutValues";
_lv = new anywheresoftware.b4a.keywords.LayoutValues();
 //BA.debugLineNum = 540;BA.debugLine="Dim p As Phone";
_p = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 541;BA.debugLine="If p.SdkVersion >= 17 Then";
if (_p.getSdkVersion()>=17) { 
 //BA.debugLineNum = 542;BA.debugLine="Dim ctxt As JavaObject";
_ctxt = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 543;BA.debugLine="ctxt.InitializeContext";
_ctxt.InitializeContext(processBA);
 //BA.debugLineNum = 544;BA.debugLine="Dim display As JavaObject = ctxt.RunMethodJO(\"ge";
...
_filename = "LivingRoomTempHumid_"+BA.NumberToString(_year)+"-"+anywheresoftware.b4a.keywords.Common.NumberFormat(_month,(int) (2),(int) (0))+"-"+anywheresoftware.b4a.keywords.Common.NumberFormat(_day,(int) (2),(int) (0))+".log";
 ...
 //BA.debugLineNum = 457;BA.debugLine="TextReader1.Initialize(File.OpenInput(File.DirR";
...
_timestamp = "";
 //BA.debugLineNum = 469;BA.debugLine="timeStamp = a(0).SubString2(0,5)";
_timestamp = _a[(int) (0)].substring((int) (0),(int) (5));
 //BA.debugLineNum = 471;BA.debugLine="If IsNumber(a(1)) = False Then Continue";
if (anywheresoftware.b4a.keywords.Common.IsNumber(_a[(int) (1)])==anywheresoftware.b4a.keywords.Common.False) { 
if (true) continue;};
 //BA.debugLineNum = 473;BA.debugLine="Select timeStamp";
...
anywheresoftware.b4a.keywords.Common.LogImpl("8393347",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 536;BA.debugLine="End Sub";
return "";
}
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 571;BA.debugLine="Sub Timer1_Tick";
 //BA.debugLineNum = 572;BA.debugLine="Activity.RequestFocus";
mostCurrent._activity.RequestFocus();
 //BA.debugLineNum = 573;BA.debugLine="lc1.RemoveView";
mostCurrent._lc1.RemoveView();
 //BA.debugLineNum = 574;BA.debugLine="Activity_Create(False)";
